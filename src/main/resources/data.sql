...
-- añadido:
INSERT INTO disenio (id, tipo, tipo_puerta, observaciones, num_puertas, alto, ancho, fondo, nombre,cliente_id, foto) VALUES (1,'Puerta', 'Corredera', 'Puerta acabado de vidrio templado', 2, 2.1, 1.5, 0.4, 'Diseño Vidrio 1',1,'http://localhost:8080/resources/images/foto_prueba.jpg' );
INSERT INTO disenio (id, tipo, tipo_puerta, observaciones, num_puertas, alto, ancho, fondo, nombre,cliente_id, foto ) VALUES (2,'Armario', 'Abatible', 'Armario de madera barnizada', 1, 2.0, 0.9, 0.5, 'Diseño Madera 1',1,'http://localhost:8080/resources/images/foto_prueba.jpg');
INSERT INTO disenio (id, tipo, tipo_puerta, observaciones, num_puertas, alto, ancho, fondo, nombre, cliente_id,foto) VALUES (3,'Armario', 'Corredera', 'Sin observaciones', 1, 2.2, 1.8, 0.6, 'Armario para la habitacion',2,'http://localhost:8080/resources/images/foto_prueba.jpg');
INSERT INTO disenio (id, tipo, tipo_puerta, observaciones, num_puertas, alto, ancho, fondo, nombre, cliente_id, foto) VALUES (4,'Vestidor', 'No', 'Sin observaciones', 1, 2.3, 1.0, 0.3, 'Diseño Minimalista 1',2,'http://localhost:8080/resources/images/foto_prueba.jpg');
INSERT INTO disenio (id, tipo, tipo_puerta, observaciones, num_puertas, alto, ancho, fondo, nombre, cliente_id, foto) VALUES (5,'Armario', 'Abatible', 'Con detalles artesanales', 2, 2.0, 1.2, 0.5, 'Diseño Rústico 1',2,'http://localhost:8080/resources/images/foto_prueba.jpg');
