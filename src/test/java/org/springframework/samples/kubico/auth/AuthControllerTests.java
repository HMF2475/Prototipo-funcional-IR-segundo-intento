...
import org.springframework.samples.kubico.auth.AuthController;
import org.springframework.samples.kubico.auth.AuthService;
import org.springframework.samples.kubico.auth.payload.request.LoginRequest;
import org.springframework.samples.kubico.auth.payload.request.SignupRequest;
import org.springframework.samples.kubico.configuration.jwt.JwtUtils;
import org.springframework.samples.kubico.configuration.services.UserDetailsImpl;
...
class AuthControllerTests {
	...
	void setup() {
		...
		signupRequest.setDireccion("Address");

		signupRequest.setFirstName("Test");
		signupRequest.setLastName("Test");
		signupRequest.setTelefono("999999999");
